...
namespace Cheesos.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        private readonly RoleManager<IdentityRole> _roleManager; // we will add roles in our website
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // assign roles for the new user (this will be disabled and implemented with database seed)
                    ...
                    // *** NOTE ***
                    // The code below registers every user as Manager. This will be removed later
                    //await _userManager.AddToRoleAsync(user, SD.ManagerUser);
                    // *** NOTE END ***
